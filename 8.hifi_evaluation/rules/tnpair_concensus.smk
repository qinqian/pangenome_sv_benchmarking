...
rule all:
    input:
        ...
        "mixedhg38_noncolo829_hifi_clean.pdf",
        "output/local/tnpair/batch34/noncolo829_clean_joint.pdf"
...
rule otherline_evaluation_local:
    ...
    output:
        ...
        joint_plot = "output/local/tnpair/batch34/noncolo829_clean_joint.pdf",
    script:
        "scripts/tn_pair_precision_recall_concensus.R"
