...
awk '($5 > 0)' hprc_grch38_wave_indels50bp.bed | bedtools slop -b 500 -g GRCh38_EBV.chrom.sizes.tsv -i - > hprc_grch38_wave_indels50bp_ins.bed
awk '($5 < 0)' hprc_grch38_wave_indels50bp.bed | bedtools slop -b 500 -g GRCh38_EBV.chrom.sizes.tsv -i - > hprc_grch38_wave_indels50bp_del.bed
