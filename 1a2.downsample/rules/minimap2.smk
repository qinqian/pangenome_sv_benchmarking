...
idx_files = expand("output/align/{cell_line}/{pair}/{assembly}.cram.crai", cell_line=celllines, pair=["T", "BL"], assembly=['grch38', 'chm13'])
files = expand("output/align/{cell_line}/{pair}/{assembly}.cram", cell_line=celllines, pair=["T", "BL"], assembly=['grch38', 'chm13'])
...
rule minimap2:
    input:
         ...
         fastq = "{cell_line}_{pair}.fastq.gz"
    output:
