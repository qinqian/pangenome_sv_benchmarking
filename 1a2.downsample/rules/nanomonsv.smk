...
rule nanomonsv_call:
    input:
        bp_bed = expand("output/nanomonsv/{{cell_line}}/{pair}/{{assembly}}_parse.bp_info.sorted.bed.gz", pair=["T", "BL"]),
        bp_bed_idx = expand("output/nanomonsv/{{cell_line}}/{pair}/{{assembly}}_parse.bp_info.sorted.bed.gz.tbi", pair=["T", "BL"]),
        del_bed = expand("output/nanomonsv/{{cell_line}}/{pair}/{{assembly}}_parse.deletion.sorted.bed.gz", pair=["T", "BL"]),
        del_bed_idx = expand("output/nanomonsv/{{cell_line}}/{pair}/{{assembly}}_parse.deletion.sorted.bed.gz.tbi", pair=["T", "BL"]),
        ins_bed = expand("output/nanomonsv/{{cell_line}}/{pair}/{{assembly}}_parse.insertion.sorted.bed.gz", pair=["T", "BL"]),
        ins_bed_idx = expand("output/nanomonsv/{{cell_line}}/{pair}/{{assembly}}_parse.insertion.sorted.bed.gz.tbi", pair=["T", "BL"]),
        trans_bed = expand("output/nanomonsv/{{cell_line}}/{pair}/{{assembly}}_parse.rearrangement.sorted.bedpe.gz", pair=["T", "BL"]),
        trans_bed_idx = expand("output/nanomonsv/{{cell_line}}/{pair}/{{assembly}}_parse.rearrangement.sorted.bedpe.gz.tbi", pair=["T", "BL"]),
        crams = expand("output/align/{{cell_line}}/{pair}/{{assembly}}.cram", pair=["T", "BL"]),
        crais = expand("output/align/{{cell_line}}/{pair}/{{assembly}}.cram.crai", pair=["T", "BL"])
    output:
