...
idx_files = expand("output/align/{cell_line}/{pair}/{assembly}.cram.crai", cell_line=celllines, pair=["tumor", "normal"], assembly=['grch38', 'chm13'])
files = expand("output/align/{cell_line}/{pair}/{assembly}.cram", cell_line=celllines, pair=["tumor", "normal"], assembly=['grch38', 'chm13'])
...
rule minimap2:
    input:
         ...
         fastq = "/hlilab/meganle/revisions/simulated_purity/simulated_{pair}_{cell_line}.fq"
    output:
