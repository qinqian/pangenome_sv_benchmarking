...
idx_files = expand(os.path.join(pwd, "output/align/{cell_line}/{pair}/{assembly}_{pair}_tag.cram.crai"), cell_line=celllines, pair=["tumor", "normal"], assembly=assembly)
files     = expand(os.path.join(pwd, "output/align/{cell_line}/{pair}/{assembly}_{pair}_tag.cram"), cell_line=celllines, pair=["tumor", "normal"], assembly=assembly)
