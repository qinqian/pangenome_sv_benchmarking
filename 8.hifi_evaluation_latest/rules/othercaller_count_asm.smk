...
rule sv_num_with_asmcount_filter:
    input:
        ...
        msv_stat     = expand("../10.mixed_assembly_10percent_latest/output/minisv_puretumor_somatic_asm/msv_ltgs_{cell_line}_hifi1_somatic_generation2_filterasm.stat",     cell_line=['COLO829', 'NCI2009','HCC1395', 'HCC1937', 'HCC1954', 'NCI1437']),
        msv_lts_stat = expand("../10.mixed_assembly_10percent_latest/output/minisv_puretumor_somatic_asm/msv_lts_{cell_line}_hifi1_somatic_generation2_filterasm.stat",     cell_line=['COLO829', 'NCI2009','HCC1395', 'HCC1937', 'HCC1954', 'NCI1437']),
