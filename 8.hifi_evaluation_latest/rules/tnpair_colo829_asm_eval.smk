...
rule colo829_tnpair_sv_evaluation_grouped_tools:
    input:
        stat = expand("../10.mixed_assembly_10percent_latest/output/minisv_puretumor_somatic_asm/{cell_line}_hifi1_grch38_count{count}_eval.tsv", cell_line=['COLO829'], count=[3,4,5,6,7]),
        ...
        stat_ont = expand("../20.ont_assembly/output/latest_minisv_puretumor_somatic_asm/{cell_line}_ont1_grch38_count{count}_eval.tsv", cell_line=['COLO829'], count=[3,4,5,6,7])
    output:
...
rule othercellline_tnpair_upset:
    input:
        ...
        union_count     = expand("../10.mixed_assembly_10percent_latest/output/minisv_puretumor_somatic_asm/origunion_{cell_line}_hifi1_somatic_generation{cutoff}_eval.tsv", cell_line=['COLO829', 'HCC1395', 'HCC1937', 'HCC1954', 'NCI1437', 'NCI2009'], cutoff=[5]),
        asm_union_count = expand("../10.mixed_assembly_10percent_latest/output/minisv_puretumor_somatic_asm/asmunion_{cell_line}_hifi1_somatic_generation{cutoff}_eval.tsv", cell_line=['COLO829', 'HCC1395', 'HCC1937', 'HCC1954', 'NCI1437', 'NCI2009'], cutoff=[5])
    output:
