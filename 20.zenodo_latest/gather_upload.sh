...
copy_severus() {
    for cell_line in COLO829_hifi1 COLO829_ont1 HCC1395_hifi1 HCC1937_hifi1 HCC1954_hifi1 NCI1437_hifi1 NCI2009_hifi1; do
        ...
        if [ $cell_line != "COLO829_ont1" ];then
            cp ../10.mixed_assembly_10percent_latest/output/minisv_puretumor_somatic_asm/severus_${cell_line}_somatic_generation3_filterasm.vcf $cell_line/severus
            cp ../10.mixed_assembly_10percent_latest/output/minisv_puretumor_somatic_asm/severus_${cell_line}_somatic_generation5_filterasm.vcf $cell_line/severus
        fi
        ...
        if [ $cell_line != "COLO829_ont1" ];then
            cp ../10.mixed_assembly_10percent_latest/output/minisv_mosaic_asm/${cell_line}_grch38_severus_lowaf25_2_asm.vcf ${cell_line}_mixed/severus 
        fi
    done
...
copy_sanava() {
    for cell_line in COLO829_hifi1 COLO829_ont1 HCC1395_hifi1 HCC1937_hifi1 HCC1954_hifi1 NCI1437_hifi1 NCI2009_hifi1; do
        ...
        if [ $cell_line != "COLO829_ont1" ];then
            cp ../10.mixed_assembly_10percent_latest/output/minisv_puretumor_somatic_asm/savana_${cell_line}_somatic_generation3_filterasm.vcf $cell_line/savana
            cp ../10.mixed_assembly_10percent_latest/output/minisv_puretumor_somatic_asm/savana_${cell_line}_somatic_generation5_filterasm.vcf $cell_line/savana
        fi
    done
    for cell_line in COLO829_ont1; do
...
copy_nanomonsv() {
    for cell_line in COLO829_hifi1 COLO829_ont1 HCC1395_hifi1 HCC1937_hifi1 HCC1954_hifi1 NCI1437_hifi1 NCI2009_hifi1; do
        ...
        if [ $cell_line != "COLO829_ont1" ];then
            cp ../10.mixed_assembly_10percent_latest/output/minisv_puretumor_somatic_asm/nanomonsv_${cell_line}_somatic_generation3_filterasm.vcf $cell_line/nanomonsv
            cp ../10.mixed_assembly_10percent_latest/output/minisv_puretumor_somatic_asm/nanomonsv_${cell_line}_somatic_generation5_filterasm.vcf $cell_line/nanomonsv
        fi
    done
...
copy_snf2() {
    for cell_line in COLO829_hifi1 COLO829_ont1 HCC1395_hifi1 HCC1937_hifi1 HCC1954_hifi1 NCI1437_hifi1 NCI2009_hifi1; do
        ...
        if [ $cell_line != "COLO829_ont1" ];then
            cp ../10.mixed_assembly_10percent_latest/output/minisv_puretumor_somatic_asm/snf_${cell_line}_somatic_generation3.vcf $cell_line/sniffles2/grch38_snf_somatic.vcf
            cp ../10.mixed_assembly_10percent_latest/output/minisv_puretumor_somatic_asm/snf_${cell_line}_somatic_generation3_filterasm.vcf $cell_line/sniffles2/
            cp ../10.mixed_assembly_10percent_latest/output/minisv_puretumor_somatic_asm/snf_${cell_line}_somatic_generation5.vcf $cell_line/sniffles2/grch38_snf_somatic.vcf
            cp ../10.mixed_assembly_10percent_latest/output/minisv_puretumor_somatic_asm/snf_${cell_line}_somatic_generation5_filterasm.vcf $cell_line/sniffles2/
        fi
        ...
        if [ $cell_line != "COLO829_ont1" ];then
            cp ../10.mixed_assembly_10percent_latest/output/minisv_mosaic_asm/${cell_line}_grch38_snf_lowaf25_2_asm.vcf ${cell_line}_mixed/sniffles2
        fi
    done
...
copy_ensembl() {
    for cell_line in COLO829_hifi1 HCC1395_hifi1 HCC1937_hifi1 HCC1954_hifi1 NCI1437_hifi1 NCI2009_hifi1; do
        ...
        cp ../10.mixed_assembly_10percent_latest/output/minisv_puretumor_somatic_asm/asmunion_${cell_line}_somatic_generation5_insilico_truth_collapsed.msv ensembl/${cell_line}/
        cp ../10.mixed_assembly_10percent_latest/output/minisv_puretumor_somatic_asm/asmunion_${cell_line}_somatic_generation5_insilico_truth.msv ensembl/${cell_line}/
    done
}
...
copy_normal_calls() {
    ...
    for cl in HG00099 HG002 HG01192 HG03225 NA18983; do
        cp ../8.hifi_evaluation_latest/normal_v2/msv/${cl}.hg38*c2s0*.msv normal_cell

        cp ../1b.alignment_sv_tools_normal/output/latest_severus/${cl}/grch38/all_SVs/severus_all.vcf normal_cell/grch38_severus_all_${cl}.vcf

        cp ../1b.alignment_sv_tools_normal/output/latest_sniffles_mo/${cl}/grch38.vcf.gz normal_cell/grch38_sniffles2_mosaic_${cl}.vcf.gz
