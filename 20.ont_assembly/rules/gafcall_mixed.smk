rule minisv_mosaic_mixed_ltg_e:
    ...
    resources:
        ...
        run_time="8h"
    input:
        paf = expand("output/align/{{cell_line}}_{{platform}}/{assembly}_mixdown.paf.gz", assembly=['chm13', 'grch38']),
        gaf = expand("output/align/{{cell_line}}_{{platform}}/{assembly}g_mixdown.paf.gz", assembly=['chm13', 'grch38']),
    output:
        rsv = "output/minisv_mosaic/{cell_line}_{platform}/grch38l_l+t+g_mosaic.rsv"
    shell: 
        """
...
rule minisv_call:
    ...
    output:
        msv = "output/minisv_mosaic/{cell_line}_{platform}/grch38l_l+t+g_mosaic.msv.gz"
    shell: 
        """
...
rule minisv_mosaic_mixed_lt_e:
    ...
    input:
        ...
        gaf = expand("output/align/{{cell_line}}_{{platform}}/{assembly}g_mixdown.paf.gz", assembly=['chm13', 'grch38']),
    output:
        rsv = "output/minisv_mosaic/{cell_line}_{platform}/grch38l_l+t_mosaic.rsv"
    shell: 
        """
...
use rule minisv_call as minisv_call_lt with:
    ...
    output:
        msv = "output/minisv_mosaic/{cell_line}_{platform}/grch38l_l+t_mosaic.msv.gz"
...
rule minisv_mosaic_mixed_lg_e:
    ...
    resources:
        ...
        run_time="8h"
    input:
        paf = "output/align/{cell_line}_{platform}/{assembly}_mixdown.paf.gz",
        gaf = "output/align/{cell_line}_{platform}/{assembly}g_mixdown.paf.gz"
    output:
...
use rule minisv_call as minisv_call_lg with:
    ...
    output:
        msv = "output/minisv_mosaic/{cell_line}_{platform}/{assembly}l_l+g_mosaic.msv.gz"
...
rule minisv_mosaic_mixed_l_extract:
    ...
    input:
        paf = "output/align/{cell_line}_{platform}/{assembly}_mixdown.paf.gz",
    output:
        rsv = "output/minisv_mosaic/{cell_line}_{platform}/{assembly}l_l+x_mosaic.rsv"
    shell: 
        """
...
use rule minisv_call as minisv_call_l with:
    ...
    output:
        msv = "output/minisv_mosaic/{cell_line}_{platform}/{assembly}l_l+x_mosaic.msv.gz"
...
rule minisv_mosaic_mixed_g_extract:
    ...
    input:
        gaf = "output/align/{cell_line}_{platform}/{assembly}g_mixdown.paf.gz"
    output:
        rsv = "output/minisv_mosaic/{cell_line}_{platform}/{assembly}g_g+x_mosaic.rsv"
    shell: 
        """
