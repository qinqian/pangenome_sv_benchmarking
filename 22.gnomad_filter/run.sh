...
main() {
    ...
    /hlilab/alvin/miniconda3/envs/gafcall/bin/k8 /hlilab/alvin/miniconda3/envs/gafcall/bin/minisv.js eval -l 100  -c 3 -b ~/data/pangenome_sv_benchmarking/minisv/data/hs38.reg.bed /homes6/hli/hli1/gafcall/COLO829.truth.hs38.vcf *COLO829_ont1*vcf ../1a.alignment_sv_tools/output/savana13/COLO829_ont1/grch38/grch38_T_tag.classified.somatic.vcf ../1a.alignment_sv_tools/output/severus_latest/COLO829_ont1/grch38_cutoff2_read_ids/somatic_SVs/severus_somatic.vcf ../1a.alignment_sv_tools/output/nanomonsv_latest/COLO829_ont1/grch38_tnpair.vcf  > COLO829_ont1_eval.tsv
    
    #Rscript plot_gnomad.R
    Rscript gnomad_filter_colo829_fpfn.R
}
